        ...
        >
          ...
          <Menu.Item style={{ width: "80%" }}>
            <Form warning={!!fieldErrors.length}>
              <Form.Field>
                <p style={{ textAlign: "start", paddingBottom: 20 }}>You can click in the map to select the charger location. Add your address, your energy source and select the marketer that you want to sell your energy. Once the form is complete, click on Submit button.</p>
              </Form.Field>
              <Form.Field>
              ...
              <Form.Field>
                ...
                <Dropdown value={providerSource} name='dropdownValue' fluid selection options={providerSources} onChange={this.handleChangeSource} />
              </Form.Field>
              <Form.Field>
              ...
              <Form.Field>
                <label className="sidebarLabel">Amount kWh you want to Sell for a month:</label>
                <Input
                  name='amountkWh'
              ...
              <ShastaButton onClick={this.closeForm} style={{ marginRight: 30 }}>Close</ShastaButton>
              <ShastaButton disabled={!!fieldErrors.length} onClick={this.addProducer} type='submit'>Submit</ShastaButton>
              </div>
            </Form>
          </Menu.Item>
        </Sidebar>
        <span style={{ fontSize: '1.71428571rem', marginRight: 40 }}>Current providers</span>
        <ShastaSellButton onClick={this.openForm}>Sell your energy</ShastaSellButton>
